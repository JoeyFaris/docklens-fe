export default function FooterCTA({ onConnectClick }) {
  return (
    <div className="py-24 bg-gradient-to-b from-white to-green-50 w-screen relative overflow-hidden">
        ...
        <div className="animate-on-scroll opacity-0 max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button
              ...
              className="w-full sm:w-auto px-8 py-4 bg-green-600 hover:bg-green-700 rounded-xl font-bold text-lg transition-all duration-300 shadow-prominent hover:shadow-prominent-hover transform hover:translate-y-[-2px] text-white flex items-center justify-center group"
            >
              Connect to Docker
      ...
      <footer className="mt-24 border-t border-gray-200">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            {/* Company Info */}
            <div>
              <h4 className="font-semibold text-gray-900 mb-4">ContainerOps</h4>
              <p className="text-sm text-gray-600 mb-4">Making container management simple and efficient for developers and teams.</p>
