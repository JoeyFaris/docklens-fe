...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white w-screen overflow-x-hidden">
      ...
      <div className="relative bg-gradient-to-b from-blue-900 to-gray-900 w-screen">
        ...
        <div className="mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-24 relative">
          ...
          <div className={`max-w-7xl mx-auto ${animatedElements.hero ? 'animate-fade-in-up' : 'opacity-0'}`}>
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold mb-6 leading-tight text-transparent bg-clip-text bg-gradient-to-r from-blue-300 to-blue-500 max-w-4xl">
            ...
            <div className="flex flex-col sm:flex-row gap-6 mb-8">
              <button
                ...
                className="px-8 py-4 bg-blue-600 hover:bg-blue-700 rounded-lg font-medium text-lg transition-all duration-300 shadow-blue hover:shadow-blue-lg transform hover:translate-y-[-2px] text-white flex items-center justify-center"
              >
                Connect to Docker
                <svg className="ml-2 h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div className="flex items-center space-x-2 text-sm text-blue-300 max-w-2xl">
      ...
      {/* Key Features */}
      <div className="py-16 bg-gray-900 w-screen">
        <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="animate-on-scroll opacity-0 text-center mb-12">
            ...
            <p className="text-blue-300 max-w-3xl mx-auto">DockLens provides comprehensive visibility into your Docker environment with zero setup required.</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 mb-16">
            <div className="animate-on-scroll opacity-0 bg-gray-800 border border-gray-700 rounded-xl p-6 shadow-md hover:shadow-blue transition-all duration-300 hover:border-blue-600">
              ...
              <p className="text-blue-100">Identify vulnerabilities and security risks in your Docker containers in real-time.</p>
            </div>
            ...
            <div className="animate-on-scroll opacity-0 bg-gray-800 border border-gray-700 rounded-xl p-6 shadow-md hover:shadow-blue transition-all duration-300 hover:border-blue-600">
              ...
              <p className="text-blue-100">Get detailed insights into container performance and resource usage.</p>
            </div>
            ...
            <div className="animate-on-scroll opacity-0 bg-gray-800 border border-gray-700 rounded-xl p-6 shadow-md hover:shadow-blue transition-all duration-300 hover:border-blue-600">
              ...
              <p className="text-blue-100">Smart recommendations to improve container performance and reduce resource usage.</p>
            </div>
          </div>
          
          <div className="animate-on-scroll opacity-0 max-w-5xl mx-auto">
            <div className="mb-6">
              <div className="h-0.5 w-16 bg-blue-600 mb-6"></div>
              <h3 className="text-2xl font-bold mb-6 text-white">Key capabilities</h3>
            </div>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-4">
              <div className="flex items-start">
                <CheckIcon className="h-5 w-5 text-blue-400 mr-2 flex-shrink-0 mt-0.5" />
                <span className="text-blue-100">Zero setup required</span>
              </div>
              <div className="flex items-start">
                <CheckIcon className="h-5 w-5 text-blue-400 mr-2 flex-shrink-0 mt-0.5" />
                <span className="text-blue-100">Unlimited containers with no user-based licensing</span>
              </div>
              <div className="flex items-start">
                <CheckIcon className="h-5 w-5 text-blue-400 mr-2 flex-shrink-0 mt-0.5" />
                <span className="text-blue-100">Embed analytics into applications</span>
              </div>
              <div className="flex items-start">
                <CheckIcon className="h-5 w-5 text-blue-400 mr-2 flex-shrink-0 mt-0.5" />
                <span className="text-blue-100">Schedule dashboard reports</span>
              </div>
              <div className="flex items-start">
                <CheckIcon className="h-5 w-5 text-blue-400 mr-2 flex-shrink-0 mt-0.5" />
                <span className="text-blue-100">Generate data visualizations from natural language</span>
              </div>
              <div className="flex items-start">
                <CheckIcon className="h-5 w-5 text-blue-400 mr-2 flex-shrink-0 mt-0.5" />
      ...
      {/* Pricing Section */}
      <div className="py-16 bg-gray-800 w-screen">
        <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="animate-on-scroll opacity-0 text-center mb-12">
            <h3 className="text-2xl sm:text-3xl font-bold text-white mb-4">Simple, transparent pricing</h3>
            <p className="text-blue-300 max-w-3xl mx-auto">Choose the plan that's right for you, with no hidden fees.</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {/* Free Plan */}
            <div className="animate-on-scroll opacity-0 bg-gray-900 rounded-2xl overflow-hidden border border-gray-700 hover:border-blue-600 transition-all duration-300 hover:shadow-blue h-full">
              <div className="p-8 flex flex-col h-full">
                <div className="flex justify-between items-start mb-4">
                  ...
                  <span className="px-3 py-1 bg-green-900/40 text-green-400 text-sm rounded-full">
                    Available Now
                  </span>
                </div>
                <ul className="space-y-3 mb-6 flex-grow">
                  <li className="flex items-start">
                    <CheckIcon className="h-5 w-5 text-blue-400 mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-blue-100">Basic container analytics</span>
                  </li>
                  <li className="flex items-start">
                    <CheckIcon className="h-5 w-5 text-blue-400 mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-blue-100">Container status monitoring</span>
                  </li>
                  <li className="flex items-start">
                    <CheckIcon className="h-5 w-5 text-blue-400 mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-blue-100">Image information</span>
                  </li>
                </ul>
                <button
                  onClick={() => setShowAnalyzeModal(true)}
                  className="w-full py-3 text-center bg-blue-600 hover:bg-blue-700 rounded-lg font-medium transition-colors text-white mt-auto"
                >
                  Get Started
                </button>
              </div>
            ...
            {/* Premium Plan */}
            <div className="animate-on-scroll opacity-0 bg-gradient-to-b from-blue-900/50 to-gray-900 rounded-2xl border border-blue-700/50 overflow-hidden transition-all duration-300 hover:shadow-blue-lg h-full">
              <div className="p-8 flex flex-col h-full">
                <div className="flex justify-between items-start mb-4">
                  <div>
                    <h4 className="text-xl font-bold mb-1 text-white">Premium</h4>
                    <p className="text-3xl font-bold text-white">$19<span className="text-lg font-normal text-blue-300">/month</span></p>
                  </div>
                  <span className="px-3 py-1 bg-blue-900/40 text-blue-400 text-sm rounded-full">
                    Coming Soon
                  </span>
                </div>
                <ul className="space-y-3 mb-6 flex-grow">
                  <li className="flex items-start">
                    <CheckIcon className="h-5 w-5 text-blue-400 mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-blue-100">Advanced security scanning</span>
                  </li>
                  <li className="flex items-start">
                    <CheckIcon className="h-5 w-5 text-blue-400 mr-2 flex-shrink-0 mt-0.5" />
                  ...
                  <li className="flex items-start">
                    <CheckIcon className="h-5 w-5 text-blue-400 mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-blue-100">Custom report generation</span>
                  </li>
                </ul>
                <div className="mt-auto">
                  <form onSubmit={handleNotificationSignup} className="flex flex-col space-y-3">
                    <input
                      ...
                      className="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none text-white placeholder-gray-500"
                      required
                    />
                    <button
                      type="submit"
                      ...
                      className={`w-full px-4 py-3 rounded-lg font-medium ${
                        isSubmitting ? 'bg-gray-700 text-gray-400' : 'bg-blue-600 text-white hover:bg-blue-700'
                      } transition-colors`}
                    >
      ...
      {/* Footer CTA */}
      <div className="py-16 bg-gradient-to-b from-gray-800 to-gray-900 w-screen">
        <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl text-center">
          <div className="animate-on-scroll opacity-0 max-w-3xl mx-auto">
            ...
            <button
              onClick={() => setShowAnalyzeModal(true)}
              className="px-8 py-4 bg-blue-600 hover:bg-blue-700 rounded-lg font-medium text-lg transition-all duration-300 shadow-blue hover:shadow-blue-lg transform hover:translate-y-[-2px] text-white"
            >
              Connect to Docker
            </button>
          </div>
